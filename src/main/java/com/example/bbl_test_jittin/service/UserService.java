package com.example.bbl_test_jittin.service;
...
public class UserService {
    ...
    private static long counterId = 10;
    ...
    private void init() {
        ...
        List<User> userList = mapper.readValue(json, new TypeReference<>() {});
    ...
    public User updateUser(long userId, User userRequest) throws Exception {
        ...
        if (userOld != null) {
            ...
            userMap.put(userId, userRequest);
            return userRequest;
        }
        return null;
    }
